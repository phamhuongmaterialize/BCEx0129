...
public class DeviceInitialDialog extends DialogFragment {

    /**
     * タグ
     */
    private static final String TAG = DeviceInitialDialog.class.getSimpleName();

    /**
     * フラグメントのレイアウト
     */
    private static final int FRGMLAYOUT_XML = R.layout.device_initial_dialog;
    ...
    //======================================================================
    public static DeviceInitialDialog newInstance() {
        DeviceInitialDialog inst = new DeviceInitialDialog();
        return inst;
    }
